 ...
 * החודש שנבחר בחיצים שבראש המסך, והטבלה מציגה חלון של שנים־עשר חודשים שאינו
 * נחתך בו — אחרת "לחודש" היה שורה אחת. עד שהחיצים נוספו הטווח היה נעול על
 * החודש הנוכחי (0144), וזו הסיבה שהטבלה נכתבה כך מלכתחילה.
 */
...
export const CustomerEventsCountWidget = sectionKpi<Monthly>({
  ...
  /* "בחודש" ולא "החודש": מאז שיש חיצים בראש המסך הכרטיס אינו מדבר בהכרח על
     החודש הנוכחי, ושם החודש כתוב ממילא בכותרת שמעליו. */
  label: 'אירועים בחודש',
  icon: CalendarDays,
  tone: '#3b82f6',
  delta: true,
