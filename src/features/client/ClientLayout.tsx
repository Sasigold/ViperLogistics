...
import { ICON, LogOut, Moon, STROKE, Sun, Truck } from '../../components/ui/icons'
    ...
    <div className="min-h-full bg-canvas">
      <header className="sticky top-0 z-30 border-b border-line bg-surface/85 backdrop-blur-md">
        <div className="mx-auto flex h-14 max-w-5xl items-center gap-2.5 px-4">
          <span
            className="flex size-8 shrink-0 items-center justify-center rounded-lg bg-primary text-on-primary"
            aria-hidden
          >
