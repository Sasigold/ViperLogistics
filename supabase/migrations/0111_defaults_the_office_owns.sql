-- 0111: שלוש ברירות מחדל שהמשרד מחזיק, ומי שמולן אינו בוחר
--
...
comment on column customer_execution_methods.is_default is
  'אופן הביצוע שכל משימה חדשה של הלקוח נולדת איתו (0111). אחד לכל היותר.';
...
begin
  ...
  -- ‏0111: נקודת ההתחלה היא של המשרד. בלי המפתח המשרדי מה שנשלח מהקורא
