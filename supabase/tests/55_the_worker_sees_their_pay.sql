...
-- ===========================================================================
-- 55: העובד רואה את השכר שלו בדוח הנוכחות (0198).
--
...
insert into auth.users (id, email) values
  ('00000000-0000-0000-0000-0000000055a1', 'c55-worker@vl.test'),
  ('00000000-0000-0000-0000-0000000055a2', 'c55-nopay@vl.test'),
  ('00000000-0000-0000-0000-0000000055a3', 'c55-manager@vl.test');

insert into profiles (id, user_id, user_kind, is_admin, full_name) values
  ('20000000-0000-0000-0000-0000000055a1', '00000000-0000-0000-0000-0000000055a1',
   'staff', false, 'עובד 55'),
  ('20000000-0000-0000-0000-0000000055a2', '00000000-0000-0000-0000-0000000055a2',
   'staff', false, 'עובד בלי שכר 55'),
  ('20000000-0000-0000-0000-0000000055a3', '00000000-0000-0000-0000-0000000055a3',
   'staff', false, 'מנהל 55');

insert into worker_pay_settings (profile_id, hourly_rate) values
  ('20000000-0000-0000-0000-0000000055a1', 50),
  ('20000000-0000-0000-0000-0000000055a2', 50),
  ('20000000-0000-0000-0000-0000000055a3', 60);

insert into user_permission_grants (profile_id, permission_key, allowed) values
  ('20000000-0000-0000-0000-0000000055a1', 'attendance.view_own',     true),
  ('20000000-0000-0000-0000-0000000055a1', 'attendance.view_own_pay', true),
  ('20000000-0000-0000-0000-0000000055a2', 'attendance.view_own',     true),
  ('20000000-0000-0000-0000-0000000055a2', 'attendance.view_own_pay', false),
  ('20000000-0000-0000-0000-0000000055a3', 'attendance.view_all',     true),
  ('20000000-0000-0000-0000-0000000055a3', 'attendance.view_own_pay', true),
  ('20000000-0000-0000-0000-0000000055a3', 'attendance.view_pay',     false);
...
select v.id::uuid, v.pid::uuid, d, 1,
  ...
  from (select (current_date + 860 - extract(isodow from current_date + 860)::int + 1) as d) w,
       (values ('50000000-0000-0000-0000-0000000055a1', '20000000-0000-0000-0000-0000000055a1'),
               ('50000000-0000-0000-0000-0000000055a2', '20000000-0000-0000-0000-0000000055a2'),
               ('50000000-0000-0000-0000-0000000055a3', '20000000-0000-0000-0000-0000000055a3')) v(id, pid);


\echo '--- 1. העובד רואה את השכר שלו ---'

set role authenticated;
select set_config('request.jwt.claim.sub', '00000000-0000-0000-0000-0000000055a1', false);
...
select set_config('request.jwt.claim.sub', '00000000-0000-0000-0000-0000000055a2', false);
...
select set_config('request.jwt.claim.sub', '00000000-0000-0000-0000-0000000055a3', false);
...
select t_eq('גם כשהוא מסנן לעובד אחר',
  (attendance_report(current_date + 850, current_date + 870,
     array['20000000-0000-0000-0000-0000000055a1']::uuid[]) ->> 'can_see_pay')::boolean, false);
select t_eq('אבל כשהוא מסנן לעצמו הוא רואה את השכר שלו',
  (attendance_report(current_date + 850, current_date + 870,
     array['20000000-0000-0000-0000-0000000055a3']::uuid[]) ->> 'can_see_pay')::boolean, true);
select t_eq('והסכום שלו הוא שלו',
  (attendance_report(current_date + 850, current_date + 870,
     array['20000000-0000-0000-0000-0000000055a3']::uuid[]) #>> '{totals,total}')::numeric, 480::numeric);
