...
-- נסיעה חזרה. ‏0164: מי שהמשימה האחרונה שלו בשטח מסיים בשטח — הנסיעה חזרה
...
-- ‏0164: הנסיעה נכנסת לשעת הסיום רק כשהמשימה האחרונה חוזרת למחסן, ולכן
...
-- ‏0164: האחרונה חוזרת למחסן, ולכן הנסיעה שלה (0.25) היא זו שנספרת. אילו
-- הייתה בשטח — לא הייתה נסיעה כלל, וזה בדיוק מה שחבילה 42 בודקת.
insert into task_assignments (task_id, profile_id, role, work_site) values
